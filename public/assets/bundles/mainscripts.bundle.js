...
$.AdminNexa.browser = {
    ...
    $.AdminNexa.browser.activate(), $.AdminNexa.leftSideBar.activate(), $.AdminNexa.rightSideBar.activate(), $.AdminNexa.navbar.activate(), $.AdminNexa.input.activate()
    /*, $.AdminNexa.select.activate()*/, $.AdminNexa.search.activate(), setTimeout(function() {
