...
<nav class="navbar">
    <div class="col-12">
        ...
        <ul class="nav navbar-nav navbar-right">
            ...
            <li><a href={{ route('employee.auth.forgot-password.post') }} class="mega-menu" data-close="true"><i class="zmdi zmdi-power"></i></a></li>
...
<aside id="leftsidebar" class="sidebar">
    ...
    <div class="user-info">
        <div class="image">
            <img src='{{ url("/assets/images/xs/avatar1.jpg") }}' width="48" height="48" alt="User" />
        </div>
        <div class="info-container">
            ...
            <div class="btn-group user-helper-dropdown">
                ...
                <ul class="dropdown-menu slideUp">
                    ...
                    <li class="divider"></li> -->
                    <li><a href="{{ route('employee.auth.logout') }}"><i class="material-icons">input</i>Sign Out</a></li>
                </ul>
            </div>
    ...
    <div class="block-header">
        <div class="row">
            <div class="col-lg-7 col-md-6 col-sm-12">
                <h2>Dashboard
                <small class="text-muted">Welcome to SIC Application</small>
                </h2>
            </div>
            <div class="col-lg-5 col-md-6 col-sm-12">
                <ul class="breadcrumb float-md-right">
                    <li class="breadcrumb-item"><a href="index.html"><i class="zmdi zmdi-home"></i> SIC</a></li>
