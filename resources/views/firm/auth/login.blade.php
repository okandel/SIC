@extends('firm.layout.anonymous_master')

@section('title') Login @endsection

@section('content') 
    <form  id="loginform"  class="col-lg-12" id="sign_in" method="POST" action="{{ route('firm.auth.login') }}">
    ...
    <div class="col-lg-12 m-t-20">
        <a class="" href="{{ route('firm.auth.forgot-password') }}">Forgot Password?</a>
    </div> 
@stop
