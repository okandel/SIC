...
<div class="page-loader-wrapper">
    <div class="loader">
		...
		<div class="line"></div>
        <p>Please wait...</p>
        <div class="m-t-30"><img src='{{ url("/assets/images/logo.svg") }}' width="48" height="48" alt="SIC"></div>
    </div>
</div>
...
<div class="search-bar">
    ...
    <input type="text" placeholder="Explore SIC...">
...
<nav class="navbar">
    <div class="col-12">
        ...
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="index.html">SIC</a>
        </div>
        ...
        <ul class="nav navbar-nav navbar-right">
            ...
            <li><a href="{{ route('firm.auth.logout') }}" class="mega-menu" data-close="true"><i class="zmdi zmdi-power"></i></a></li>
...
<aside id="leftsidebar" class="sidebar">
    ...
    <div class="user-info">
        <div class="image">
            <img src='{{ url("/uploads/defaults/client.png") }}' width="48" height="48" alt="User" />
        </div>
        <div class="info-container">
            <div class="name" data-toggle="dropdown">{{session()->get('user_firm')->first_name}} {{session()->get('user_firm')->last_name}}</div>
            <div class="btn-group user-helper-dropdown">
                ...
                <ul class="dropdown-menu slideUp">
                    <li><a href="{{url('firm/users').'/'.session()->get('user_firm')->id.'/profile'}}"><i class="material-icons">person</i>Profile</a></li>
                    <li class="divider"></li>
                    <li><a href="{{ route('firm.auth.logout') }}"><i class="material-icons">input</i>Sign Out</a></li>
                </ul>
            </div>
            <div class="email mr-3" style="width: 100%">{{session()->get('user_firm')->email}}</div>
        </div>
    </div>
    <!-- #User Info -->
    <!-- Menu -->

    @include('firm/layout/sidebar')
    <!-- #Menu -->
</aside>
<!-- Right Sidebar -->
            ...
            <div class="right_chat slim_scroll">
                ...
                <ul class="list-unstyled">
                    <li class="offline inlineblock">
                        <a href="javascript:void(0);">
                            <div class="media">
                                <img class="media-object " src='{{ url("/assets/images/xs/avatar10.jpg") }}' alt="">
                                <div class="media-body">
                                    <span class="badge badge-outline status"></span>
                                </div>
                            </div>
                    ...
                    <li class="offline inlineblock">
                        <a href="javascript:void(0);">
                            <div class="media">
                                <img class="media-object " src='{{ url("/assets/images/xs/avatar6.jpg") }}' alt="">
                                <div class="media-body">
                                    <span class="badge badge-outline status"></span>
                                </div>
                            </div>
                    ...
                    <li class="offline inlineblock">
                        <a href="javascript:void(0);">
                            <div class="media">
                                <img class="media-object " src='{{ url("/assets/images/xs/avatar7.jpg") }}' alt="">
                                <div class="media-body">
                                    <span class="badge badge-outline status"></span>
                                </div>
                            </div>
                    ...
                    <li class="offline inlineblock">
                        <a href="javascript:void(0);">
                            <div class="media">
                                <img class="media-object " src='{{ url("/assets/images/xs/avatar8.jpg") }}' alt="">
                                <div class="media-body">
                                    <span class="badge badge-outline status"></span>
                                </div>
                            </div>
                    ...
                    <li class="offline inlineblock">
                        <a href="javascript:void(0);">
                            <div class="media">
                                <img class="media-object " src='{{ url("/assets/images/xs/avatar9.jpg") }}' alt="">
                                <div class="media-body">
                                    <span class="badge badge-outline status"></span>
                                </div>
                            </div>
...
<!-- Chat-launcher -->
<div class="chat-launcher" style="display:none"></div>
    ...
    <div class="card">
        ...
        <div class="body">
            ...
            <ul class="chat-scroll-list clearfix">
                ...
                <li class="left float-left"> <img src='{{ url("/assets/images/xs/avatar2.jpg") }}' class="rounded-circle" alt="">
                ...
                <li class="left float-left"> <img src='{{ url("/assets/images/xs/avatar1.jpg") }}' class="rounded-circle" alt="">
...
<!-- 
'assets/plugins/jquery/jquery-v3.2.1.min.js','assets/plugins/bootstrap/js/bootstrap.js' -->
