...
@section('title') Edit template field @endsection
...
@section('breadcrumbs')
    <div class="row">
        <div class="col-sm-4">
            <h4 class="ml-4 mt-3"><i class="fa fa-tools fa-1x"></i> Edit Item Template Field</h4>
        </div>
        <div class="col-sm-8">
            <ul class="breadcrumb">
                <li class="breadcrumb-item float-md-right ml-3 mr-4">
                    <p>{{ Breadcrumbs::render('item-template-fields-edit', $template, $field) }}</p>
                </li>
            </ul>
        </div>
    </div>
    ...
    <div class="row clearfix">
        <div class="col-sm-12">
            <div class="card">
                ...
                <div class="body">
                    <form method="post" action="{{ url('firm/item-template/'.$ItemTemplateId.'/custom-fields/'.$field->id.'/update') }}">
