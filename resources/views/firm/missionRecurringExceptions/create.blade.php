...
@section('title') Create vacation @endsection

@section('breadcrumbs')
    <div class="row">
        <div class="col-sm-3">
            <h4 class="ml-4 mt-3"><i class="fa fa-exclamation-triangle fa-1x"></i> Create vacation</h4>
        </div>
        <div class="col-sm-9">
            <ul class="breadcrumb">
                <li class="breadcrumb-item float-md-right ml-3 mr-4">
                    <p>{{ Breadcrumbs::render('mission-recurring-exceptions-create') }}</p>
                </li>
            </ul>
        </div>
    </div>
        ...
        <div class="row clearfix">
            <div class="col-sm-12">
                <div class="card">
                    ...
                    <div class="body">
                        <form method="post" action="{{ url('firm/mission-recurring-exceptions/store') }}">
